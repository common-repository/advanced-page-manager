...
class ApmNodeDataDisplay{
	...
	public function load_from_wp_page($wp_page,$no_marked_infos=false,$no_wp_data=false){
		...
		//Temp variable used to avoid pass by reference error in following line
		$loaded_apm_id_temp = array_keys($intern_data_loaded['nodes_data']);
		$loaded_apm_id = array_pop($loaded_apm_id_temp);
